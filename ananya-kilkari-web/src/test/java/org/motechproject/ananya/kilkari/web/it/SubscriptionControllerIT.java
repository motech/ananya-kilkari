...
public class SubscriptionControllerIT extends SpringIntegrationTest {
    ...
    public void shouldChangeMsisdnForAnExistingSubscription() throws Exception {
        ...
        when(mockReportingService.getSubscriber(oldSubscription.getSubscriptionId())).thenReturn(new SubscriberResponse("subscriptionId", "name", 25, null, null, null, null, null, null));

...
public class ChangeMsisdnValidatorTest {
    ...
    public void shouldValidateChangeMsisdnRequest() {
        ...
        Subscription subscription1 = new Subscription(oldMsisdn, SubscriptionPack.BARI_KILKARI, DateTime.now(), DateTime.now(), null, "1234567890", true);
    ...
    public void shouldValidateChangeMsisdnForAllSubscriptionToBeUpdatableWhenAllPacksSpecified() {
        ...
        Subscription subscription2 = new Subscription(oldMsisdn, SubscriptionPack.NANHI_KILKARI, DateTime.now(), DateTime.now(), null, "1234567890", true);
        subscription2.setStatus(SubscriptionStatus.SUSPENDED);

        Subscription subscription3 = new Subscription(oldMsisdn, SubscriptionPack.NAVJAAT_KILKARI, DateTime.now(), DateTime.now(), null, "1234567890", true);
    ...
    public void shouldValidateIfTheNewMsisdnIsAlreadySubscribedToAnyOfTheGivenPacks() {
        ...
        Subscription oldMsisdnSubscription = new Subscription(oldMsisdn, pack, DateTime.now(), DateTime.now(), null, "1234567890", true);
        oldMsisdnSubscription.setStatus(SubscriptionStatus.ACTIVE);
        Subscription newMsisdnSubscription1 = new Subscription(newMsisdn, pack, DateTime.now(), DateTime.now(), null, "1234567890", true);
        newMsisdnSubscription1.setStatus(SubscriptionStatus.SUSPENDED);
        Subscription newMsisdnSubscription2 = new Subscription(newMsisdn, SubscriptionPack.BARI_KILKARI, DateTime.now(), DateTime.now(), null, "1234567890", true);
    ...
    public void shouldValidateIfTheNewMsisdnIsAlreadySubscribedToAnyOfTheGivenPacksWhenAllSpecified() {
        ...
        Subscription subscription3 = new Subscription(newMsisdn, SubscriptionPack.NAVJAAT_KILKARI, DateTime.now(), DateTime.now(), null, "1234567890", true);
        subscription3.setStatus(SubscriptionStatus.PENDING_ACTIVATION);

...
public class AllSubscriptionsIT extends SpringIntegrationTest {
    ...
    public void shouldAddASubscriptionIntoDb() {
        ...
        Subscription subscription = new Subscription(msisdn, SubscriptionPack.NAVJAAT_KILKARI, createdAt, startDate, weekNumber, null, false);
        ...
        assertEquals(weekNumber, subscriptionFromDb.getStartWeekNumber());
        assertNotNull(subscriptionFromDb.getSubscriptionId());
        assertEquals(SubscriptionPack.NAVJAAT_KILKARI, subscriptionFromDb.getPack());
    ...
    public void shouldQueryForSubscriptionsInDbBasedOnGivenMsisdn() {
        ...
        Subscription subscription1 = new Subscription(msisdn, SubscriptionPack.NAVJAAT_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
        Subscription subscription2 = new Subscription(msisdn, SubscriptionPack.BARI_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
        Subscription subscription3 = new Subscription("2314567890", SubscriptionPack.BARI_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
        ...
        assertTrue(Arrays.asList(new SubscriptionPack[]{SubscriptionPack.NAVJAAT_KILKARI, SubscriptionPack.BARI_KILKARI}).contains(filteredSubscriptions.get(0).getPack()));
        assertTrue(Arrays.asList(new SubscriptionPack[]{SubscriptionPack.NAVJAAT_KILKARI, SubscriptionPack.BARI_KILKARI}).contains(filteredSubscriptions.get(1).getPack()));
    }
    ...
    public void shouldFindSubscriptionByMsisdnAndPack() {
        ...
        Subscription subscription3 = new Subscription(msisdn, SubscriptionPack.NAVJAAT_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
        ...
        List<Subscription> allSubscriptionsByMsisdnAndPack = allSubscriptions.findByMsisdnAndPack(msisdn, SubscriptionPack.NAVJAAT_KILKARI);
    ...
    public void shouldFindSubscriptionInProgress() {
        ...
        Subscription subscription2 = new Subscription(msisdn, SubscriptionPack.NAVJAAT_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
    ...
    public void shouldFindSubscriptionsInProgress() {
        ...
        Subscription subscription2 = new Subscription(msisdn, SubscriptionPack.NANHI_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
        subscription2.setStatus(SubscriptionStatus.COMPLETED);
        allSubscriptions.add(subscription2);

        Subscription subscription3 = new Subscription(msisdn, SubscriptionPack.BARI_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
    ...
    public void shouldDeleteAllForSubscriptionID() {
        Subscription subscription = new Subscription("1234", SubscriptionPack.NANHI_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
        allSubscriptions.add(subscription);

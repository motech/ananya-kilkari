...
public class SubscriptionControllerIT extends SpringIntegrationTest {
    ...
    public void shouldRetrieveSubscriptionDetailsFromDatabaseForIVR() throws Exception {
        ...
        final Subscription subscription1 = new Subscription(msisdn, SubscriptionPack.NAVJAAT_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
        final Subscription subscription2 = new Subscription(msisdn, SubscriptionPack.BARI_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
    ...
    public void shouldRetrieveSubscriptionDetailsFromDatabaseForCC() throws Exception {
        ...
        final Subscription subscription1 = new Subscription(msisdn, SubscriptionPack.NAVJAAT_KILKARI, now, now, startWeekNumber, null, false);
        final Subscription subscription2 = new Subscription(msisdn, SubscriptionPack.BARI_KILKARI, now, now, startWeekNumber, null, false);
        allSubscriptions.add(subscription1);
        allSubscriptions.add(subscription2);
        final InboxMessage inboxMessage1 = new InboxMessage(subscription1.getSubscriptionId(), "WEEK23");
        final InboxMessage inboxMessage2 = new InboxMessage(subscription2.getSubscriptionId(), "WEEK2");
        ...
        markForDeletion(inboxMessage2);
        ReportingService mockedReportingService = mock(ReportingService.class);
        final SubscriberResponse reportResponse1 = new SubscriberResponse(subscription1.getSubscriptionId(), "beneficiaryName", 25, now, now, now, new LocationResponse("s","d", "b", "p"), now, now.minusDays(3), null);
        final SubscriberResponse reportResponse2 = new SubscriberResponse(subscription2.getSubscriptionId(), "beneficiaryName1", 26, now, now, now, new LocationResponse("s1","d1", "b1", "p1"), now, now.minusDays(8), null);
        ...
        ArrayList<SubscriptionDetailsResponse> subscriptionDetailsResponses = new ArrayList<SubscriptionDetailsResponse>() {{
            ...
            SubscriptionDetailsResponse detailsResponse1 = new SubscriptionDetailsResponse(subscription1.getSubscriptionId(), subscription1.getPack(),
                    ...
                    locationResponse1.getBlock(), locationResponse1.getPanchayat()), now, now, now.minusDays(3), null, DateTime.now());
            SubscriptionDetailsResponse detailsResponse2 = new SubscriptionDetailsResponse(subscription2.getSubscriptionId(),
                    ...
                    locationResponse2.getBlock(), locationResponse2.getPanchayat()), now, now, now.minusDays(8), null, DateTime.now());
    ...
    public void shouldChangeMsisdnForAnExistingSubscription() throws Exception {
        ...
        when(mockReportingService.getSubscriber(oldSubscription.getSubscriptionId())).thenReturn(new SubscriberResponse("subscriptionId", "name", 25, null, null, null, null, null, null, null));

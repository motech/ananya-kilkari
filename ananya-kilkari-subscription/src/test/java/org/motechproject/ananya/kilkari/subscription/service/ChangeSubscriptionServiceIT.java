...
public class ChangeSubscriptionServiceIT extends SpringIntegrationTest {
    ...
    public void shouldChangePackForAnExistingSubscription() {
        ...
        ChangeSubscriptionRequest changeSubscriptionRequest = new ChangeSubscriptionRequest(ChangeSubscriptionType.CHANGE_PACK, msisdn, existingSubscription.getSubscriptionId(), SubscriptionPack.NAVJAAT_KILKARI, Channel.CONTACT_CENTER, DateTime.now(), DateTime.now().plusMonths(1), null, "reason", null, false);

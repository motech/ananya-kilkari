...
public class SubscriptionTest {
    ...
    public void shouldInitializeSubscription() {
        ...
        Subscription subscription = new Subscription(msisdn, SubscriptionPack.BARI_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
    ...
    public void shouldChangeStatusOfSubscriptionToPendingDuringActivationRequest() {
        Subscription subscription = new Subscription("1234567890", SubscriptionPack.BARI_KILKARI, DateTime.now(), DateTime.now(), null, null, false);
        subscription.setStatus(SubscriptionStatus.NEW);
    ...
    public void shouldChangeStatusOfSubscriptionToActiveForSuccessfulActivation() {
        ...
        Subscription subscription = new Subscription("1234567890", SubscriptionPack.BARI_KILKARI, createdAt, activatedOn, null, null, false);
        subscription.setStatus(SubscriptionStatus.NEW);
    ...
    public void shouldReturnIsActiveBasedOnStatus() {
        ...
        Subscription subscription = new Subscription(msisdn, pack, DateTime.now(), DateTime.now(), null, null, false);
    ...
    public void shouldFloorCreationDateToExactMinutes() {
        ...
        Subscription subscription = new Subscription("abcd", SubscriptionPack.BARI_KILKARI, dateWithSeconds, DateTime.now(), null, null, false);
    ...
    public void shouldFloorStartDateForSubscriptionToExactMinutes_forLateSubscription() {
        ...
        Subscription subscription = new Subscription("abcd", SubscriptionPack.BARI_KILKARI, now, now.minusWeeks(2), null, null, false);
    ...
    public void shouldFloorStartDateForSubscriptionToExactMinutes_forNonLateSubscription() {
        DateTime now = DateTime.now();
        Subscription subscription = new Subscription("abcd", SubscriptionPack.BARI_KILKARI, now.minusWeeks(2), now, null, null, false);

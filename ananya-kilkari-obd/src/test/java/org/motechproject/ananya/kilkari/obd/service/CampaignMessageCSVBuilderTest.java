...
public class CampaignMessageCSVBuilderTest {
    ...
    public void shouldReturnCsvContentForAList() {
        ...
        campaignMessages.add(new CampaignMessage("subscriptionId1","message1", DateTime.now(), "1234567891", "operator1", DateTime.now().plusDays(2)));
        campaignMessages.add(new CampaignMessage("subscriptionId2","message2", DateTime.now(), "1234567892", "operator2", DateTime.now().plusDays(2)));
        campaignMessages.add(new CampaignMessage("subscriptionId3","message3", DateTime.now(), "1234567893", "operator3", DateTime.now().plusDays(2)));

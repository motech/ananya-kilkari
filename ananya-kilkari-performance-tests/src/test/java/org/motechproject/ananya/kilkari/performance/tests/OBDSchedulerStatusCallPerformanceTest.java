...
public class OBDSchedulerStatusCallPerformanceTest extends BasePerformanceTest {
    ...
    public void loadSubscriptions() {
        for (int i = 0; i < numberOfMessagesInDb/100; i++) {
            ...
            Subscription subscription = new Subscription(msisdn, SubscriptionPack.BARI_KILKARI, now, now, null);
            ...
            campaignMessage.setFailureStatusCode(CampaignMessageStatus.NEW);

...
public class InboxCallDetailsWebRequestTest {
    ...
    public void shouldValidateInvalidRequest() {
        ...
        InboxCallDetailsWebRequest inboxCallDetailsWebRequest = new InboxCallDetailsWebRequest("1234567890", "WEEK", callDurationWebRequest, "invalid_pack");
    ...
    public void shouldValidateValidRequest() {
        ...
        String endTime = DateTime.now().toString("dd-MM-yyyy HH-mm-ss");
        CallDurationWebRequest callDurationWebRequest = new CallDurationWebRequest(startTime, endTime);
        InboxCallDetailsWebRequest inboxCallDetailsWebRequest = new InboxCallDetailsWebRequest("1234567890", "WEEK12", callDurationWebRequest, "choti_kilkari");
